...
log_level = 'INFO'
load_from = 'work_dirs/yolov8x_signalman/best_coco_bbox_mAP_epoch_96.pth'
resume = True
...
data_root = '/SSD2/si/construction_signalman'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/SSD2/si/construction_signalman',
        ann_file=
        '/SSD2/code/0_PD_2023/Research/Manuscrip_1_2023/data/preprocessed_labels/signalman/signalman_train_data.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='images'),
        ann_file=
        '/SSD2/code/0_PD_2023/Research/Manuscrip_1_2023/data/preprocessed_labels/signalman/signalman_test_data.json',
        pipeline=[
            dict(
                type='LoadImageFromFile',
                file_client_args=dict(backend='disk')),
...
launcher = 'pytorch'
work_dir = './work_dirs/yolov8x_signalman'
